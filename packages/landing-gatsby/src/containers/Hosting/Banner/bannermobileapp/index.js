...
import HomeImg from 'common/src/assets/image/hosting/Pages/mobileapp/mobileapp-section.png';
...
const BannerHomeSection = ({
  ...
  const Data = useStaticQuery(graphql`
    query {
      file(
        relativePath: {
          eq: "image/hosting/Pages/mobileapp/mobileapp-section-1-img.png"
        }
      ) {
        childImageSharp {
          fluid(maxWidth: 650) {
            ...
            <Box {...col} {...textArea}>
              <Fade left cascade>
                <div>
                  ...
                  <div>
                    <Heading {...title} content="Mobile" />
                  </div>
                  <div>
                    <Heading {...title} content="Commerce" />
                  </div>
                  <Heading
                    {...title1}
