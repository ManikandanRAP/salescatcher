...
import InfoSection from '../containers/Hosting/book-a-demo';
...
import BannerSection from '../containers/Hosting/Banner/book-a-demo';
...
export default () => {
  return (
    <ThemeProvider theme={hostingTheme}>
      <ParallaxProvider>
        <SEO title="Buy Back Bot | Communicate better / Convert more" />
